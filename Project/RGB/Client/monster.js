...
monster.points = power; //*****power is not defined*****
...
/**
*I've added this from my last version of monster.js that I was debugging and never pushed.  It may not be needed anymore. -Max
*/
function createMonster(){
  let newMon = new monster(); //Power level here doesn't do anything yet
  colorScreen(newMon.monsterColor);
}
