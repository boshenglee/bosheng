...
public class PolarAngleComparator implements Comparator<Point>
{
	 ...
	 */
	public PolarAngleComparator(Point p) {referencePoint = p;}
	...
	public int compare(Point p1, Point p2)
	{
		...
		else if((comparePolarAngle(p1,p2)<0)) {return -1;}
		else if(comparePolarAngle(p1,p2)==0&&compareDistance(p1,p2)<0) {return -1;}
		else {return 1;}
	}
	...
	public int comparePolarAngle(Point p1, Point p2)
	{
		...
		else if (!p1.equals(referencePoint) && !p2.equals(referencePoint) && crossProduct(p1, p2) == 0 && dotProduct(p1, p2) > 0) {return 0;}
		else if (p1.equals(referencePoint)) {return -1;}
		else if (!p2.equals(referencePoint)){
			if (p1.getY() < referencePoint.getY() && p2.getY() < referencePoint.getY() && crossProduct(p1, p2) > 0) {return -1;}
			if (p1.getY() == referencePoint.getY()) {
				if (p2.getY() < referencePoint.getY()) {return -1;}
				if (p2.getY() == referencePoint.getY() && p1.getX() > referencePoint.getX() && p2.getX() < referencePoint.getX()) {return -1;}
				if (p2.getY() > referencePoint.getY() && p1.getX() > referencePoint.getX()) {return -1;}
			}
			if (p1.getY() > referencePoint.getY()) {
				if (p2.getY() > referencePoint.getY() && crossProduct(p1, p2) > 0) {return -1;}
				if (p2.getY() == referencePoint.getY() && p2.getX() < referencePoint.getX()) {return -1;}
				if (p2.getY() < referencePoint.getY()) {return -1;}
			}
		}
		else {return 1;}
